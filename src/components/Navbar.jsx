            ...
            <div className='flex items-center p-3 relative'>
                <input
                    ...
                    onChange={(event) => {
                        ...
                        setShowSuggestion(true); // Show suggestion chart on input change
                    }}
                    placeholder='search'
                    className='bg-black/5 border border-white/20 rounded-l-full outline-none p-1 px-5 h-10 w-[29rem]'
                />
